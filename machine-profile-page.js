/* Kútfő Plusz ERP – Géppark: adatlap KÖZVETLENÜL a Géppark tartalmi területén */
(function(){
'use strict';
...
function contentRoot(){return document.getElementById('content')||document.querySelector('.content');}
function install(){
 function show(id){
  ...
  // FONTOS: csak a #content tartalmát cseréljük le. Nem modal, nem drawer, nem új oldal.
  ...
  const title=document.getElementById('title');if(title)title.textContent='Géppark';
